...
allowed-tools: mcp__sjmcp__dc_recall, mcp__sjmcp__dc_search_within, mcp__sjmcp__dc_get
---
...
1. Identify the target file. If the user named a session id (8 hex) or a `sj://…` URI, use it
